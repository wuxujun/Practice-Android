 ...
 */
public class RLangEditActivity extends BaseActivity{

    @ViewInject(R.id.etLangName)
    private FormEditText        etTitle;
    @ViewInject(R.id.etLangContent)
    private FormEditText        etMsg;

    @ViewInject(R.id.tvLangTime)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_r_lang);
    ...
    private void save(){
        ...
        http.send(HttpRequest.HttpMethod.POST, URLs.RESUME_LANG_ADD, getRequestParams(requestMap), new RequestCallBack<String>() {
            @Override
    ...
    private void gotoLangActivity(){
        Intent intent=new Intent();
        RLangEditActivity.this.setResult(AppConfig.SUCCESS,intent);
        RLangEditActivity.this.finish();
    }
}
