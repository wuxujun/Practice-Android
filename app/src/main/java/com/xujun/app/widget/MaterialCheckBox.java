...
/**
 * Created by xujunwu on 15/10/27.
 */
public class MaterialCheckBox  extends View {
    ...
    private void init(Context context) {
        ...
        backgroundColor = getResources().getColor(R.color.gray_white);
        borderColor = getResources().getColor(R.color.blue);
        ...
        paintCenter.setColor(getResources().getColor(R.color.gary_btn));
